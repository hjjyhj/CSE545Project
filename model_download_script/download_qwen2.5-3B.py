...
print("Downloading tokenizer for Qwen2.5-3B-Instruct...")
tokenizer = AutoTokenizer.from_pretrained(MODEL_NAME)

print("Downloading Qwen2.5-3B-Instruct model weights... This may take time.")
...
print(f"Qwen2.5-3B-Instruct model saved to: {SAVE_PATH}")
